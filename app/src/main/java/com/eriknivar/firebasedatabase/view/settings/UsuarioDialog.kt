...
fun UsuarioDialog(
    ...
    val requiereCambio = selectedUser?.requiereCambioPassword ?: true
    ...
    AlertDialog(
        ...
        text = {
            Column(verticalArrangement = Arrangement.spacedBy(8.dp)) {
                ...
                OutlinedTextField(
                    value = contrasena,
                    onValueChange = if (requiereCambio) ({ _: String -> }) else onContrasenaChange,
                    label = { Text("Contraseña") },
                    singleLine = true,
                    enabled = !requiereCambio,
                    trailingIcon = {
                        if (requiereCambio) {
                            Icon(
                ...
                // ✅ Campo adicional visible solo para superuser
                if (esSuperuser) {
                    OutlinedTextField(
                        value = clienteId,
